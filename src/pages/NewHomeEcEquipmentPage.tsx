...
import { Search, Plus, Minus, ArrowLeft, ChefHat, Home, Lightbulb, Wrench, ChevronRight } from 'lucide-react';
...
const NewHomeEcEquipmentPage: React.FC = () => {
  ...
  // Define custom category order for Home Ec equipment
  const CUSTOM_CATEGORY_ORDER = ['home-ec', 'production-set'];

  // Define category icons and colors for Home Ec equipment
  const categoryConfig = {
    'home-ec': { icon: ChefHat, color: 'from-orange-500 to-orange-600', bgColor: 'bg-orange-50', textColor: 'text-orange-700' },
    'production-set': { icon: Home, color: 'from-purple-500 to-purple-600', bgColor: 'bg-purple-50', textColor: 'text-purple-700' },
  };
  ...
  useEffect(() => {
    const loadEquipment = async () => {
      try {
        ...
        setEquipment(data);
        console.log('Fetched home ec equipment:', data);
      } catch (err) {
  ...
  const renderQuickNavButtons = (isMobile: boolean) => {
    return sortedCategories.map((category) => {
      const config = categoryConfig[category as keyof typeof categoryConfig] || categoryConfig['home-ec'];
  ...
  const getCategoryDisplayName = (category: string) => {
    switch (category.toLowerCase()) {
      case 'home-ec': return 'Kitchen & Home Ec';
      case 'production-set': return 'Production Set Rentals';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading home ec equipment...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => window.location.reload()} className="bg-orange-600 text-white px-4 py-2 rounded-lg">
            Try Again
          </button>
        </div>
      </div>
        ...
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h1 className="text-lg font-bold text-gray-900">Home Ec Equipment</h1>
              <p className="text-sm text-gray-600">Kitchen equipment and set decoration</p>
            </div>
          </div>
      ...
      <div className="hidden lg:block bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Home Economics Equipment</h1>
              <p className="text-gray-600 mt-1">Professional kitchen equipment, tableware, furniture, and set decoration for culinary productions</p>
            </div>
            <div className="w-80">
          ...
          <div className="px-4 lg:px-8 py-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link
                ...
                className="inline-flex items-center px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-medium text-sm"
              >
...
export default NewHomeEcEquipmentPage;